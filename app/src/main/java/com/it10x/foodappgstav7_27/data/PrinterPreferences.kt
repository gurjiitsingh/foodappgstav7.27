package com.it10x.foodappgstav7_27.data

import android.content.Context
import android.hardware.usb.UsbManager
import com.it10x.foodappgstav7_27.data.PrinterConfig
import com.it10x.foodappgstav7_27.printer.PaperSize
import com.it10x.foodappgstav7_27.data.pos.entities.PrinterEntity
...
//*******************************
    ...
    fun getReceiptPrintMode(
        ...
        val value = prefs.getString(
            receiptModeKey(role),
            ReceiptPrintMode.TEXT.name   // ✅ Fast Print default
        ) ?: ReceiptPrintMode.TEXT.name

        return try {
            ReceiptPrintMode.valueOf(value)
        } catch (e: Exception) {
            ReceiptPrintMode.TEXT        // ✅ fallback is also Fast Print
        }
    }

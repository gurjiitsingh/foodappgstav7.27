...
import com.it10x.foodappgstav7_27.printer.billimage.ReceiptBitmapGenerator
import com.it10x.foodappgstav7_27.printer.common.CountryBillFormatter
...
object ReceiptFormatter {
    ...
    fun billing32(order: PrintOrder, outletInfo: OutletInfo): String {
...
""".trimIndent()
    ...
    fun billing48(
        ...
        return CountryBillFormatter.billing48(
            order = order,
            outletInfo = outletInfo,
    ...
    fun billing32IMAGE(
        ...
        // Temporary: use 48-char / 80mm image layout
        return billing48IMAGE(
            order = order,
            outletInfo = outletInfo,
            context = context,
            logo = logo,
...
//                                    )
    ...
    fun posKitchen_old_without_MODIFIER(
        sessionKey: String,
        tableName:String,
        orderType: String,
        items: List<PosKotItemEntity>,
    ...
    fun salesCategoryProductList(
        category: String,
        items: List<com.it10x.foodappgstav7_27.ui.reports.model.ProductReportItem>,
        outletInfo: OutletInfo,
        width: Int,
        fromMillis: Long,
        toMillis: Long,

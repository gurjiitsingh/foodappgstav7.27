package com.it10x.foodappgstav7_27.navigation
...
import com.it10x.foodappgstav7_27.ui.setting.DeviceRoleSelectionScreen
import com.it10x.foodappgstav7_27.ui.waiter.WaiterPosScreen
import com.it10x.foodappgstav7_27.com.it10x.foodappgstav7_27.ui.tables.TableScreen
import com.it10x.foodappgstav7_27.com.ui.settings.PrinterRoleSelectionScreen
...
import com.it10x.foodappgstav7_27.data.pos.viewmodel.POSOrdersViewModelFactory
import com.it10x.foodappgstav7_27.printer.PrinterManager
import com.it10x.foodappgstav7_27.ui.categories.LocalCategoriesScreen
import com.it10x.foodappgstav7_27.ui.home.HomeScreen
import com.it10x.foodappgstav7_27.ui.orders.online.OnlineOrdersScreen
import com.it10x.foodappgstav7_27.ui.orders.local.LocalOrderDetailScreen
import com.it10x.foodappgstav7_27.ui.orders.local.LocalOrderDetailViewModel
import com.it10x.foodappgstav7_27.ui.orders.local.LocalOrderDetailViewModelFactory
import com.it10x.foodappgstav7_27.ui.orders.local.LocalOrdersScreen


import com.it10x.foodappgstav7_27.ui.pos.PosScreen
import com.it10x.foodappgstav7_27.ui.products.LocalProductsScreen
import com.it10x.foodappgstav7_27.ui.settings.*
import com.it10x.foodappgstav7_27.viewmodel.*
...
import com.it10x.foodappgstav7_27.data.pos.repository.CustomerRepository
...
import com.it10x.foodappgstav7_27.ui.cart.CartViewModelFactory
import com.it10x.foodappgstav7_27.ui.customer.CustomerLedgerScreen
import com.it10x.foodappgstav7_27.ui.customer.CustomerLedgerViewModel
import com.it10x.foodappgstav7_27.ui.customer.CustomerLedgerViewModelFactory
import com.it10x.foodappgstav7_27.ui.customer.CustomerListScreen
import com.it10x.foodappgstav7_27.ui.customer.CustomerViewModel
import com.it10x.foodappgstav7_27.ui.customer.CustomerViewModelFactory
import com.it10x.foodappgstav7_27.ui.delivery.DeliverySettlementScreen
import com.it10x.foodappgstav7_27.ui.delivery.DeliverySettlementViewModel
import com.it10x.foodappgstav7_27.ui.orders.history.HistoryOrdersScreen
import com.it10x.foodappgstav7_27.ui.orders.history.OrderItemsScreen

import com.it10x.foodappgstav7_27.ui.pos.PosSessionViewModel
import com.it10x.foodappgstav7_27.ui.pos.customer.CustomerAddressScreen
import com.it10x.foodappgstav7_27.ui.reports.CategoryProductReportScreen
import com.it10x.foodappgstav7_27.ui.reports.CategorySalesScreen
import com.it10x.foodappgstav7_27.ui.reports.ProductSalesScreen
import com.it10x.foodappgstav7_27.ui.reports.TotalSalesReportScreen

import com.it10x.foodappgstav7_27.ui.sales.SalesScreen
import com.it10x.foodappgstav7_27.ui.sales.SalesViewModel
import com.it10x.foodappgstav7_27.ui.sales.SalesViewModelFactory
import com.it10x.foodappgstav7_27.ui.tables.WaiterTableViewScreen
...
import com.it10x.foodappgstav7_27.ui.dayclosing.DayClosingScreen
import com.it10x.foodappgstav7_27.ui.dayclosing.DayClosingViewModel
import com.it10x.foodappgstav7_27.ui.dayclosing.DayClosingViewModelFactory
import com.it10x.foodappgstav7_27.ui.kot.history.KotHistoryDetailScreen
import com.it10x.foodappgstav7_27.ui.kot.history.KotHistoryScreen
import com.it10x.foodappgstav7_27.ui.pos.FastFoodPosScreen
import com.it10x.foodappgstav7_27.ui.pos.RetailPosScreen
 import com.it10x.foodappgstav7_27.ui.kot.history.KotHistoryViewModel
import com.it10x.foodappgstav7_27.ui.kot.history.KotHistoryViewModelFactory
import com.it10x.foodappgstav7_27.ui.pos.RunningOrdersScreen
import com.it10x.foodappgstav7_27.ui.tables.TableChangeScreen
...
// -----------------------------
    ...
    val virtualTableRepository = remember {
        VirtualTableRepository(
            virtualDao = db.virtualTableDao(),
            cartDao = db.cartDao(),
            kotDao = db.kotItemDao(),
        ...
        composable("running_orders") {
            ...
            RunningOrdersScreen(
                ...
                onTableSelected = { table ->
                    ...
                    // ---------------------------------------------------------
                    // SET THE SELECTED VIRTUAL TABLE IN THE SHARED POS SESSION
                    // ---------------------------------------------------------
                    ...
                    // ---------------------------------------------------------
                    // OPEN POS FOR THIS EXACT VIRTUAL TABLE
                    // ---------------------------------------------------------

                    navController.navigate(
                        "pos?tableId=${table.id}" +
                                "&tableName=${table.tableName}" +
                                "&orderType=${table.orderType}"
                    )
                },
...
// ---------------- SALES ----------------
        ...
        composable("products_sales") {
            ...
            // ✅ Database
            val db = com.it10x.foodappgstav7_27.data.pos.AppDatabaseProvider.get(context)

            // ✅ Products ViewModel (IMPORTANT)
            val productsViewModel: com.it10x.foodappgstav7_27.data.pos.viewmodel.ProductsLocalViewModel =
                viewModel(
                    factory = com.it10x.foodappgstav7_27.data.pos.viewmodel.ProductsLocalViewModelFactory(
                        db.productDao()
                    )
                )
        ...
        composable("outlet_information") {
            OutletInformationScreen(
                navController = navController
            )
        }
